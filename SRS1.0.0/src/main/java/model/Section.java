...
//	唯一标识
	...
	public JSONObject  WriteJson() throws JSONException {
	    JSONObject member1 = new JSONObject();  
			member1.put("seatingCapacity",getSeatingCapacity() );
			member1.put("sectionNo",getSectionNo());  
			member1.put("room",getRoom());  
//			member1.put("professor",getInstructor().getName());  
			member1.put("courseNo",getRepresentedCourse().getCourseNo());  
			member1.put("courseName",getRepresentedCourse().getCourseName());  
			return member1;
	}
